...
function Publication() {
  ...
  return (
    <div data-reveal data-reveal-load-delay="60" className="publication">
      <div data-reveal className="tab-header page-head page-head--publication">
        <h1>Publication</h1>
      ...
      >
        <div className="publication__controls-intro page-controls__intro">
          ...
          <p>
            Combine category filters and text search to quickly find relevant publications.
          </p>
        </div>
        <div className="publication__controls-grid page-controls__grid">
          <section className="publication__controls-group page-controls__group">
            <div className="publication__controls-head">
              <p className="publication__controls-label page-controls__label">Filter by research area</p>
            ...
            <div className="publication__filter page-controls__actions" role="group" aria-label="Filter publications by area">
          ...
          <section className="publication__controls-group page-controls__group">
            <div className="publication__controls-head">
              <label className="publication__search-label page-controls__label" htmlFor="publication-search">
                Search publications
              </label>
              <p className="publication__controls-caption page-controls__caption">
            ...
            <div className="publication__search-layout">
              ...
              <div className="publication__scope-wrap">
                <p className="publication__scope-label page-controls__label">Search scope</p>
                <div className="publication__scope page-controls__actions" role="group" aria-label="Publication search scope">
