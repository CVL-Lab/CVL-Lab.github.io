        ...
        <div className="home-introduction">
            <div
                ...
                <p className="home-introduction__lead">
                    CVL-Lab advances computer vision and learning through
                    foundational methods and domain-focused applications.
                </p>
                <p className="home-introduction__body">
                    We work on a broad range of machine learning problems with a
                    strong focus on computer vision. Our research includes
                    large-scale vision models and learning methods for
                    perception, representation, and decision-making. We apply
                    these models to practical challenges in diverse domains,
                    including industrial and medical data.
                </p>
                <div
                    className="home-introduction__focus"
                    aria-label="Lab research focus">
                    {RESEARCH_FOCUS.map((item) => (
                        <span
                            key={item}
                            className="home-introduction__focus-chip">
                            {item}
                        </span>
                    ))}
                </div>
                ...
                <figure
                    ...
                    {featuredMedia?.image ? (
                        <img
                            ...
                            alt={featuredMedia.alt || featuredMedia.title}
                        />
                    ) : (
                    ...
                    <figure
                        ...
                        {supportingMedia.image ? (
                            <img
                                ...
                                alt={
                                    supportingMedia.alt || supportingMedia.title
                                }
                            />
                        ) : (
                            <div className="home-introduction__placeholder">
