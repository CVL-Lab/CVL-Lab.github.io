            ...
            <div className="home-cta__content">
                <div className="home-block__head home-cta__head">
                    <div>
                        ...
                        <p>
                            For collaborations, student applications, and
                            research inquiries.
                        </p>
                    </div>
                </div>
                <p className="home-cta__institution">
                    We welcome collaboration, student applications, and research
                    inquiries.
                </p>
                <p>
                    CVL-Lab works with academic and industrial partners on
                    practical computer vision and learning research.
                </p>
            </div>
