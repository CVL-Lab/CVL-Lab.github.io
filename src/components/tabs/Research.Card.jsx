...
function ResearchCard({
    ...
    const keywords = Array.isArray(tags) && tags.length > 0 ? tags : subtitle;
        ...
        <article
            ...
            <div className="research-card-media">
                <Link
                    ...
                    <div
                        className="research-card-media-overlay"
                        aria-hidden="true">
                        <span className="research-card-media-cta">
                            Explore publications
                        </span>
                    </div>
                </Link>
